...
const About = () => {
    return (
        <div>
            <div className="card flex w-96 md:w-11/12 mx-auto flex-col md:flex-row mt-32 mb-52 justify-center lg:px-40">
                ...
                <div className="card-body lg:items-start  mt-8 md:mt-0 md:w-6/12 space-y-4">
                    <h2 className="text-4xl font-oswald font-bold border-b-2 border-secondary">Innovus</h2>
