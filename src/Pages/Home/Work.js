...
const Work = ({ work }) => {
    ...
    return (
        <div class="card  bg-blue-50 relative font-roboto mt-10 border-b-2 border-primary">
            <figure class="px-10 pt-10">
                <img className='bg-none rounded-md transition ease-in-out delay-150 hover:scale-110 duration-1000' src={img} alt="Shoes" class="rounded-xl" />
            </figure>
            <div class="card-body items-center">
                ...
                <h2 class="card-title font-roboto">{name}</h2>
