...
`
    ...
    return (
        <div className='grid w-9/12 mx-auto grid-cols-1 gap-4 mt-32 font-oswald'>
            <div className="card bg-base-100 shadow-xl border-l-8 border-secondary">
                <div className="card-body">
                    <h2 className="card-title">Question : 1 : How will you improve the performance of a React Application ?</h2>
                    <hr />
            ...
            <div className="card bg-base-100 shadow-xl border-l-8 border-secondary">
                <div className="card-body">
                    <h2 className="card-title">Question : 2 : What are the different ways to manage a state in a React application?</h2>
                    <hr />
            ...
            <div className="card bg-base-100 shadow-xl border-l-8 border-secondary">
                <div className="card-body">
                    <h2 className="card-title">Question : 3 : How does prototypical inheritance work?</h2>
                    <hr />
            ...
            <div className="card bg-base-100 shadow-xl border-l-8 border-secondary">
                <div className="card-body">
                    <h2 className="card-title">Question : 4 : Why you do not set the state directly in React?</h2>
                    <hr />
            ...
            <div className="card bg-base-100 shadow-xl border-l-8 border-secondary mb-12">
                <div className="card-body">
                    <h2 className="card-title">Question : 5 : You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h2>
                    <hr />
